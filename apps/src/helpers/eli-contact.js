const eliContact = {
  site: "https://equity.co.id",
  siteText: "www.equity.co.id",
  mail: "contact.center@equity.id",
  address: {
  ...
  addressText: (
    <>
      PT Equity Life Indonesia, Sahid Sudirman Center lantai 43
      <br />
